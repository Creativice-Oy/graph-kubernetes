...
export function createContainerSpecEntity(deploymentUid: string, data: k8s.V1Container) {
  return createIntegrationEntity({
    entityData: {
      ...
      assign: {
        ...
        "securityContext.readOnlyRootFilesystem": data.securityContext?.readOnlyRootFilesystem,
